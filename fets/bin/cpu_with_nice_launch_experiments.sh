...
do
    ...
    cmd="nice python ${PATH_TO_RUN_SIMULATION}/run_simulation_from_flplan.py -p GANDLF_loader_pt_3dresunet_${i}.yaml -c pretraining_col.yaml -md cpu -ld ${OFL_PATH}/bin/logs_${i}"
